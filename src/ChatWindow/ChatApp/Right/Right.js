...
function Right(props) {
    ...
    return(
        <div className="contactBox border-right col-8">
            ...
            <ChatInteraction setUserContacts={props.setUserContacts} setContactIdAndTime={props.setContactIdAndTime} currentContactMsgs={props.currentContactMsgs} setCurrentContactMsgs={props.setCurrentContactMsgs} currentUser={props.currentUser} token={props.token} firstPrint={props.firstPrint} setfirstPrint={props.setfirstPrint} />
        </div>
    );
}
